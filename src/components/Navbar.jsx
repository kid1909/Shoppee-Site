...
function Navbar() {
  ...
  const openModal = (e) => {
    {
      setModal(!modal);
      const modalDiv = document.querySelector(".modal__body");
      modalDiv.scroll(0, 0);
  ...
  return (
    <header className="header">
        ...
        <div className="header-with-search">
          ...
          <div className="header__search">
            ...
            <div className="header__search-select">
              <span className="header__search-select-label">In Store</span>
      ...
      <div className={`modal ${modal ? "active-modal" : ""}`}>
        ...
        <div className={`modal__body ${modal ? "active-modal" : ""}`}>
          {/* Register form / Sign in form */}
          <div className="auth-form">
            <div className="auth-form__container">
              <div className="auth-form__header">
                <h3 className="auth-form__heading">Register</h3>
                <span className="auth-form__switch-btn">Sign In</span>
              </div>
              ...
              <div className="auth-form__aside">
                <p className="auth-form__policy-text">
                  By registering you have accepted with
                  <a href="" className="auth-form__policy__text-link">
                    {" "}
                    Policy
                  </a>{" "}
                  &
            ...
            <div className="auth-form__socials">
              <a href="" className="btn btn--with-icon btn-face">
                <i className="fab fa-facebook-square "></i>
                Connect with Facebook
              </a>
              <a href="" className="btn btn--with-icon btn-goo">
